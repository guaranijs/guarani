import { Decoder, DERDecoder, DEREncoder, Node, PEMDecoder, PEMEncoder } from '@guarani/asn1';
...
import { decodePrivatePkcs8, decodePrivateSec1, encodePrivatePkcs8, encodePrivateSec1 } from './_private';
...
export class EcKey extends JsonWebKey implements EcKeyParams {
  ...
  public constructor(key: EcKeyParams, options: JsonWebKeyParams = {}) {
    ...
    if (params.kty && params.kty !== 'EC') {
      throw new InvalidKey(`Invalid parameter "kty". Expected "EC", got "${params.kty}".`);
    }
   ...
   */
  public static async generate(curve: SupportedEllipticCurve, options?: JsonWebKeyParams): Promise<EcKey> {
  ...
  public static parse(data: Buffer | string, options?: JsonWebKeyParams): EcKey {
