 ...
 */
export function padBits(bits: string, endianness: Endianness = 'be'): string {
 ...
 */
export function bufferToBinary(buffer: Buffer, endianness: Endianness = 'be'): string {
 ...
 */
export function binaryToBuffer(bits: string, endianness: Endianness = 'be'): Buffer {
