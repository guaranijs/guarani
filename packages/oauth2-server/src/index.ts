...
export { RegistrationContext } from './lib/context/registration.context';
...
export { RegistrationRequest } from './lib/requests/registration-request';
...
export { RegistrationResponse } from './lib/responses/registration-response';
