import { BitStringNode, Decoder, Node, ObjectIdNode, SequenceNode } from '@guarani/asn1';
 ...
 */
export function decodePublicX509(decoder: Decoder, options?: JsonWebKeyParams): EcKey {
...
export function encodePublicX509(key: EcKey): Node<any> {
  return new SequenceNode([
    new SequenceNode([new ObjectIdNode('1.2.840.10045.2.1'), new ObjectIdNode(ELLIPTIC_CURVES[key.crv].oid)]),
