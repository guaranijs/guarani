import { byteLength } from '@guarani/base64url'
...
export class RsaKey extends JsonWebKey implements RsaKeyParams {
  ...
  public constructor(
    ...
    if (typeof params.kty !== 'undefined' && params.kty !== 'RSA') {
      throw new InvalidJsonWebKeyException(
        `Invalid key parameter "kty". Expected "RSA", got "${params.kty}".`
      )
    }
